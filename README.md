...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-sendgrid-api.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-sendgrid-api)
...
```bash
php artisan vendor:publish --tag="laravel-sendgrid-api-migrations"
php artisan migrate
```
